// By DranxX Creative
/**
 * Ban Store — SQLite-based ban management.
 * Works on both Bun (bun:sqlite) and Node.js (better-sqlite3).
 */
...
/**
 * Check if a sender is banned. Auto-removes expired entries (lazy cleanup).
 */
